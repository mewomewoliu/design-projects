...
function Intro() {
  ...
  return (
    <div className="intro-main">
      <h1 className="main-h1">Mia Liu <span className="intro-subtitle">(Miaomiao)</span></h1>
      <div className="intro-content">
        <p>Mia Liu is a Product Designer based in <span className="intro-highlight">Stockholm, Sweden</span>.</p>
